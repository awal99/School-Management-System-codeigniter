				...
				*/
				...
				setTimeout(function()
				{
					...
					neonLogin.setPercentage(40 + random_pct);
						//var sch = $("#school").find(":selected").val();				
						...
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								if(login_status == 'invalid')
								{
									...
									$(".school_disabled").removeClass('form-login-error');
									$(".login-page").removeClass('logging-in');
									neonLogin.resetProgressBar(true);
								}
								else if(login_status == 'disabled')
								{
									$(".school_disabled").removeClass('hidden');
									$(".error").removeClass('form-login-error');
									$(".login-page").removeClass('logging-in');
									neonLogin.resetProgressBar(true);
								}
								else
