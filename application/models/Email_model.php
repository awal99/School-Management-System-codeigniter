...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '')
	{
		...
		if($account_type=='student'){
			$email_msg		.=	"Your login password : Student123<br />";
		}else{
			$email_msg  .= "Your login password : ";
		}

		$email_msg		.=	"Please change your password when you login to the system to protect your account.";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://www.Zinnia-Tech.com\">&copy; 2018 ".$system_name."</a></center>";
