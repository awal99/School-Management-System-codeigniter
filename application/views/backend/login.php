...
<head>
	...
	<title><?php echo get_phrase('login');?> | info-schools</title>
...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="form-login-error error hidden">
				<h3>Invalid login</h3>
				<p>Please enter correct email and password!</p>
			</div>

			<div class="form-login-error school_disabled hidden">
				<h3>Invalid login</h3>
				<p>The School you selected is currently disabled!</p>
			</div>
			...
			<div class="login-bottom-links">
				...
				<a href="<?php echo base_url();?>index.php?developer/main_page" class="link">
					<?php echo get_phrase('Register_your_school'); ?>
				</a>
			</div>
