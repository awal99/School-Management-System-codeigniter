		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'index.php?student/manage_profile/update_profile_info' , array('class' => 'form-horizontal student-edit form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                        <input type="text" class="student_id" value="<?php echo $this->session->userdata('student_id'); ?>" hidden="hidden"/>
                                ...
                                <div class="col-sm-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                            <img src="<?php echo $this->crud_model->get_image_url($settings->system_name,'student',$this->session->userdata('student_id'));?>" alt="...">
                                        </div>
...
function check_data(){
		...
		$.ajax({
			url: '<?php echo base_url();?>index.php?student/check_email_update/'+ encodeURIComponent(email)+'/'+encodeURIComponent(student_id)+'/'+"3",
			dataType: 'json',
