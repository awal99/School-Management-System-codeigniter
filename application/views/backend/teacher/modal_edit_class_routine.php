    ...
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?teacher/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select id="class_id" name="class_id" class="form-control " onchange="section_subject_select(this.value , <?php echo $param2;?>)">
                            <?php 
                            $classes = $this->db->get_where('class',array('school_id'=>$this->session->userdata('school'),'teacher_id'=>$this->session->userdata('teacher_id')))->result_array();
