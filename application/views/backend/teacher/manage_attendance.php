            	...
            	<tr class="gradeA">
                    ...
                    <td>
                    	<select name="class_id" class="form-control ">
                        	...
                        	<?php 
							$classes	=	$this->db->get_where('class',array('teacher_id'=>$this->session->userdata('teacher_id'),'school_id'=>$this->session->userdata('school')))->result_array();
                     ...
                     if($section_id==0){
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                ...
                                if($section_id == 0){
                                    $verify_data    =   array(  'school_id' => $this->session->userdata('school'),
