    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-shadow" data-collapsed="0">
            ...
            <!-- <div class="panel panel-primary" data-collapsed="0"> -->
                ...
                <form action="<?php echo base_url();?>index.php?teacher/student_marksheet_print_view/<?php echo urlencode($student_id);?>/<?php echo $row2['exam_id'];?>" class="form-horizontal form-groups-bordered validate" method="post" target="_blank">

                    <div class="panel-body">

                        <button style="float:right" type="submit" class="btn btn-primary"><?php echo get_phrase('print_mark_sheet');?></button>
                     </div>    
                </form>
