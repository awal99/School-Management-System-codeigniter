    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                	...
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                ...
                                <?php 
                                $exams = $this->db->get_where('exam' , array('school_id'=>$settings->id,'year'=>$this->session->userdata('running_year')))->result_array();
							...
							<?php 
                               // $classes	=	$this->crud_model->get_classes(); 
                                ...
                                <select name="<?php if($class_id == $row['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                    ...
                                    <?php 
                                    $subjects	=	$this->crud_model->get_subjects_by_class($row['class_id'],$settings->id); 
                ...
                <?php 
						...
						$students	=	$this->crud_model->get_students($class_id,$settings->id);
