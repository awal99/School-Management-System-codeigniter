...
<div class="row">
    ...
    <?php
    $query = $this->db->get_where('class',array('school_id'=>$this->session->userdata('school')));
    if ($query->num_rows() > 0):
    ...
    <input type="hidden" name="year" value="<?php echo $this->session->userdata('running_year'); ?>">
        ...
        <div class="col-md-12">
            <table class="table table-bordered" id="my_table">
                <thead>
                    ...
                    <?php
                    $year = explode('-', $this->session->userdata('running_year'));
                        ...
                        <tr>
                            ...
                            for ($i = 1; $i <= $days; $i++) {
                                ...
                                foreach ($attendance as $row1):
                                    //$d = strtodate($row1['date']);
                                    $d=strtotime($row1['date']);
                                    $month_dummy = date('d', $d);
