                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="system_title" 
                              value="<?php echo $settings->system_title;?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="paypal_email" 
                              value="<?php echo $settings->paypal_email;?>">
                      </div>
                  </div>
                          ...
                          <select name="language" class="form-control">
                                <?php
									...
									foreach ($fields as $field)
									{
										...
										$current_default_language	=	$settings->language;
										?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <select name="text_align" class="form-control">
                          	  <?php $text_align	=	$settings->text_align;?>
                          ...
                          <div class="col-sm-9">
                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                      <img src="<?php echo base_url();?>uploads/<?php echo $settings->system_name; ?>/logo.png" alt="...">
                                  </div>
