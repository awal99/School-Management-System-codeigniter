                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url();?>index.php?admin/modal_student_marksheet/<?php echo urlencode($row['student_id']);?>"  class="btn btn-default" >
                    ...
                    <tbody>
                        <?php 
                                $students   =   $this->db->get_where('enroll' , array(
                                    'class_id'=>$class_id ,'school_id'=>$settings->id, 'section_id' => $row['section_id'],'year'=>$settings->running_year
                                ))->result_array();
                                foreach($students as $row):?>
                        <tr>
                            <td><?php echo $this->db->get_where('student',array('student_id'=>$row['student_id']))->row()->roll;?></td>
                            ...
                            <td><?php echo $this->db->get_where('student',array('student_id'=>$row['student_id']))->row()->name;?></td>
                            <td>
                                <a href="<?php echo base_url();?>index.php?admin/modal_student_marksheet/<?php echo $row['student_id'];?>"  class="btn btn-default" >
                                      <i class="entypo-chart-bar"></i>
                                      <?php echo get_phrase('view_marksheet');?>
                                </a>
