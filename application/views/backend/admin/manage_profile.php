			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                    ...
                    //foreach($edit_data as $row):
                        ...
                        ?>
                        <?php echo form_open(base_url() . 'index.php?admin/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate account-edit','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                        <input type="text" class="admin_id" value="<?php echo $this->session->userdata('admin_id'); ?>" hidden="hidden"/>
                                ...
                                <div class="col-sm-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                                            <img src="<?php echo $this->crud_model->get_image_url($settings->system_name, 'admin' , $this->session->userdata('admin_id'));?>" alt="...">
                ...
                <div class="box-content padded">
                   ...
                   // foreach($edit_data as $row):
                        ...
                        <?php echo form_open(base_url() . 'index.php?admin/manage_profile/change_password' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit"  onclick="checkpassword()" class="btn btn-info"><?php echo get_phrase('update_profile');?></button>
                              </div>
								</div>
                        </form>
						<?php
...
<script type="text/javascript">
    ...
    function check_data(){
		...
		$.ajax({
			url: '<?php echo base_url();?>index.php?teacher/check_email_update/'+ encodeURIComponent(email)+'/'+admin_id+'/'+"2",
			dataType: 'json',
